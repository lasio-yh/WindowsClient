...
{
    public static class PInvokeService
    {
        ...
        public static extern bool ShowWindow(IntPtr hWnd, SHOW_WINDOW_COMMANDS nCmdShow);
        ...
        [DllImport("gdi32.dll")]
        public static extern IntPtr GetStockObject(WIN32_STOCKOBJECTS fnObject);
    ...
    public enum WIN32_STOCKOBJECTS
    {
        WHITE_BRUSH = 0,
        LTGRAY_BRUSH = 1,
        GRAY_BRUSH = 2,
    ...
    /// </summary>      
    [Flags]
    public enum WIN32_MESSAGEBOX_OPTIONS : uint
    {
        OkOnly = 0x000000,
        OkCancel = 0x000001,
    ...
    /// </summary>  
    public enum WIN32_MESSAGEBOX_RESULT : uint
    {
        Ok = 1,
        Cancel,
        Abort,
    ...
    public enum SHOW_WINDOW_COMMANDS : int
    {
        /// <summary>  
